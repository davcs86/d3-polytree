...
function Links(definitions, moddle, links, eventBus, elementRegistry, notifications, modellingLabels) {
  base.call(this, definitions, links, elementRegistry, notifications);
  this._moddle = moddle;
  this._links = links;
