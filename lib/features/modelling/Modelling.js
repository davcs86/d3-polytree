...
Modelling.prototype._init = function () {
  ...
  this._eventBus.on('element.updated', function (elementId, elementDefinition) {
    var lcName = getLocalName(elementDefinition);
    // TODO: dirty & hacky.
    that._elements[lcName]['_'+lcName+'s']._builder(elementId, elementDefinition);
  });
};
